...
class ConstStringEncryption(obfuscator_category.IEncryptionObfuscator):
    ...
    def obfuscate(self, obfuscation_info: Obfuscation):
        ...
        try:
            ...
            static_string_pattern = re.compile(r'\.field.+?static.+?(?P<string_name>\S+?):'
            ...
            for smali_file in util.show_list_progress(obfuscation_info.get_smali_files(),
                ...
                self.logger.debug('Encrypting constant strings in file "{0}"'.format(smali_file))
                ...
                for line_number, line in enumerate(lines):
                    ...
                    if string_match and string_match.group('string'):
                        ...
                        if (reg_type == 'v' and reg_number <= 15) or (reg_type == 'p' and
                                                                      reg_number + current_local_count <= 15):
