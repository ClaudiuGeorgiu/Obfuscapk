...
class CallIndirection(obfuscator_category.ICodeObfuscator):
    ...
    def change_method_call(self, invoke_type: str, invoke_pass: str, invoke_object: str, invoke_method: str,
                           invoke_param: str, invoke_return: str, class_name: str, new_method: StringIO):
