...
class AdvancedReflection(obfuscator_category.ICodeObfuscator):
    ...
    def __init__(self):
        ...
        # Keep track of the length of the added instructions for advanced reflection obfuscator, since there is a limit
    ...
    def obfuscate(self, obfuscation_info: Obfuscation):
        ...
        try:
            ...
            for smali_file in util.show_list_progress(obfuscation_info.get_smali_files(),
                ...
                self.logger.debug('Obfuscating dangerous APIs using reflection in file "{0}"'.format(smali_file))
            ...
            destination_file = os.path.join(destination_dir, 'AdvancedApiReflection.smali')
